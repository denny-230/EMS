...
class Employee:
  def __init__(self,root):
    ...
    img_logo=Image.open(r'emp123\logo1.png')
   ...
   # upper frame
    ...
    # Gender
    lbl_gender=Label(upper_frame,textvariable=self.var_gender,text='Gender',font=('arial', 12,'bold'),bg='white')
    lbl_gender.grid(row=4,column=2,padx=2,sticky=W)

    combo_txt_gender=ttk.Combobox(upper_frame,font=('arial', 12,'bold'),width=18,state='readonly')
    ...
    # Phone
    lbl_phone=Label(upper_frame,textvariable=self.var_phone,font=('arial', 12,'bold'),text='Phone:',bg='white')
    ...
    # Country
    lbl_country=Label(upper_frame,textvariable=self.var_country,font=('arial', 12,'bold'),text='Country:',bg='white')
   ...
   # Add Buttons
    btn_add=Button(button_frame,text='Save',font=('arial', 15,'bold'),width=13,fg='white',bg='blue')
